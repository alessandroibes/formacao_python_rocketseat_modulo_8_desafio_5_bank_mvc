...
from .interfaces.criar_pessoa_juridica_controller import CriarPessoaJuridicaControllerInterface


class CriarPessoaJuridicaController(CriarPessoaJuridicaControllerInterface):
